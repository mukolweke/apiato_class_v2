        ...
        <div class="grid-x">
            ...
            <div class="medium-9 columns" style="float: left">
                <div class="card" style="">
                    <h3 class="text-center"> Create A New Committee</h3>
                    <p class="text-center"> please fill details below correctly</p>
                    <form method="post" action="{{route('web_committee_store')}}" style="position: center; margin-top:30px;margin-left: 200px;">
                        {{csrf_field()}}
                        <div class="grid-x grid-padding-x">
                            ...
                            <br><br><br>
                            <div class="small-3 cell">
                                <label for="right-label" class="text-left">Description: </label>
                            </div>
                            <div class="small-9 cell">
                            ...
                            <br><br><br>
                            <div class="small-3 cell">
                                <label for="right-label" class="text-left">Board: </label>
                            </div>
                            <div class="small-9 cell">
                                <input type="text" name="board" id="right-label">
                            </div>
                            <br><br><br>
